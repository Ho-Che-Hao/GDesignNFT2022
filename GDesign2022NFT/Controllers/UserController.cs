...
namespace GDesign2022NFT.Controllers
{
    ...
    public partial class UserController : BaseController
    {
        ...
        {
            var vm = Wtm.CreateVM<UserListVM>();
            return PartialView(vm);
        }

        [ActionDescription("Sys.Search")]
        [HttpPost]
        public string Search(UserSearcher searcher)
        {
            var vm = Wtm.CreateVM<UserListVM>(passInit: true);
        ...
        {
            var vm = Wtm.CreateVM<UserBatchVM>(Ids: IDs);
            return PartialView(vm);
        }
        ...
        {
            var vm = Wtm.CreateVM<UserImportVM>();
            return PartialView(vm);
        }
